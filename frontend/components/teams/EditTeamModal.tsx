      ...
      <div className="w-full max-w-lg rounded-xl bg-white shadow-xl">
        ...
        <div className="space-y-4 px-5 py-5">
          ...
          <div>
            ...
            <textarea
              rows={3}
              defaultValue="A passionate team building innovative solutions for the next generation."
          ...
          <div>
            ...
            <select
              defaultValue="5"
              className="h-11 w-full rounded-lg border border-slate-200 px-3 text-sm text-slate-600 outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
            >
